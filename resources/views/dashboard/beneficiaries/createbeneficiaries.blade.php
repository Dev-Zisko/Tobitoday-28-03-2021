...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 style="text-align: center; color: #FF6723 !important;" class="m-0 font-weight-bold text-primary">Crear Beneficiario</h6>
        </div>
    <div class="card-body">
                ...
                <div class="social-line">
                    ...
                    <div class="form-group{{ $errors->has('mobile_payment') ? ' has-error' : '' }}">
                        <div class="input-group mb-3">
                            ...
                            <input id="mobile_payment" name="mobile_payment" type="number" class="form-control" placeholder="Pago móvil (Opcional)..." value="{{ old('mobile_payment') }}">
                    ...
                    <div class="form-group{{ $errors->has('phonenumber') ? ' has-error' : '' }}">
                        <div class="input-group mb-3">
                            ...
                            <input id="phonenumber" name="phonenumber" type="number" class="form-control" placeholder="Número de telefono..." value="{{ old('phonenumber') }}" required>
